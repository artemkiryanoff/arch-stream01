...
Также прикладываю файл с draw.io (Microservices.drawio) - он максимально лаконичен и скорее всего - придется дорабатывать.


Дополнительное описание сервисов (включают в себя)
Сервис авторизации:
